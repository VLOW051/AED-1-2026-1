...
void insert_Agenda(void *pBuffer)
{
  ...
  (*(int *)(char*)(pBuffer + POSITION_QTD_PESSOAS))++;
}
...
void remove_Agenda(void *pBuffer) 
{
    ...
    if (*(int *)(pBuffer + POSITION_OPCAO_MENU) > 0) {
        ...
        // POSITION_OPCAO_MENU agora guarda a escolha — search_Agenda já terminou
        // e não precisa mais do contador de ocorrências neste ponto
        ...
        *(int *)(pBuffer + POSITION_CONTADOR_LOOP) = 0;
        ...
        for (*(int *)(pBuffer + POSITION_CONTADOR_LOOP) = 0;
            *(int *)(pBuffer + POSITION_CONTADOR_LOOP) < *(int *)(pBuffer + POSITION_QTD_PESSOAS);
            ...
            if (strcmp((char *)(pBuffer + POSITION_BUSCA),
                ...
                // POSITION_CONTADOR_LOOP começa em 0, então o primeiro match
                // é o contato [1], o segundo é [2], e assim por diante

                if (*(int *)(pBuffer + POSITION_CONTADOR_LOOP) + 1 == *(int *)(pBuffer + POSITION_OPCAO_MENU)) {
